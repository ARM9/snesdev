...
main: {
    ...
    LoadOam(oam_table, $00, oam_table_size)
    LoadCgram(oam_pal, $80, 32)
...
oam_table:
// prio 0 sprites using char 0 (all $FF tiles) and sprite palette 0 (oam_pal above)
db 44, 60, 0, 0
db 44, 74, 0, 0
db 44, 90, 0, 0
db 44, 108, 0, 0
constant oam_table_size(pc() - oam_table)
