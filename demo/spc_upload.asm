...
define SPC_BINARY("spc/tunes/sf-corneria.spc")
...
LoadSPC:
    ...
    sep #$20
    lda.b #$7d        // Register $7d (EDL)
    sta $7f0100
    lda.b #$00        
    sta $7f0101
    sendMusicBlockM($7f, $0100, $00f2, $0002)
    sep #$20
    lda.b #$6c        // Register $6c (FLG)
    sta $7f0100
    lda.b #$20        // Bit 5 on (~ECEN) 
    sta $7f0101
    sendMusicBlockM($7f, $0100, $00f2, $0002)
...
InitDSP:
    ...
    ldy.w #$007F      // Reset DSP address counter.
-
    sep #$20
    tya                     // Write DSP address register byte.
    sta.l $7f0100            
    lda.l dsp_reg_data,x      
    sta.l $7f0101         // Write DSP data register byte.    
